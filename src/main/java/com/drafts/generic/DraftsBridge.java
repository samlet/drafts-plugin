...
@Singleton
public class DraftsBridge implements Container, ComponentProvider {
    private static final String module = DraftsBridge.class.getName();
    ...
    private void buildContext() throws IOException {
        ...
        this.injector = Guice.createInjector(new AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(ComponentProvider.class).toInstance(DraftsBridge.this);
